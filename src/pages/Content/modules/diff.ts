...
export const fetchGetFileReviewers = async () =>
    Promise.all([fetchHeraldMapping(), fetchAlfredMapping(), fetchGroupReviewers()])
        .then(([heraldMapping, alfredMapping, groupReviewers]) => {
        ...
        .catch(() => {
            console.log("Fetching file reviewers failed");
        })
